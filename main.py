...
while running:
    ...
    if (distance(ship_pos, left_circle_pos) < circle_radius + 10 or 
        distance(ship_pos, right_circle_pos) < circle_radius + 10):
    ...
    pygame.draw.polygon(screen, ship_color, 
        [(ship_screen_pos[0] + 20 * math.cos(math.radians(ship_angle)), 
          ship_screen_pos[1] - 20 * math.sin(math.radians(ship_angle))),
         (ship_screen_pos[0] + 10 * math.cos(math.radians(ship_angle + 120)), 
          ship_screen_pos[1] - 10 * math.sin(math.radians(ship_angle + 120))),
         (ship_screen_pos[0] + 10 * math.cos(math.radians(ship_angle - 120)), 
          ship_screen_pos[1] - 10 * math.sin(math.radians(ship_angle - 120)))])
